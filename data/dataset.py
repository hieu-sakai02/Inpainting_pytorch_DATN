...
class Dataset(data.Dataset):
    ...
    def __getitem__(self, index):
        sample_filename = self.samples[index].replace(self.data_path, '')  # Remove base directory from sample filename
        path = os.path.join(self.data_path, sample_filename.strip("/")) 
